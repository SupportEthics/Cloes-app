...
export const SEED_PLACES: Place[] = [
  {
    id: 'seed_woods',
    name: 'Bluebell Woods',
    location: 'Middleton, 12 min away',
    emoji: '🌲',
    gradient: 'woods',
    status: 'would_again',
    tags: ['outdoors', 'free', 'toddler', 'nearby'],
    cost: 'Free',
    travelTime: '12 min',
  ...
  },
  {
    ...
    location: 'Coast, 25 min away',
    emoji: '🏖️',
    gradient: 'beach',
    status: 'not_yet',
    tags: ['outdoors', 'free', 'fullday', 'nearby'],
    cost: 'Free',
    travelTime: '25 min',
  ...
  },
  {
    ...
    location: 'Guiseley, 15 min away',
    emoji: '🤸',
    gradient: 'soft',
    status: 'would_again',
    tags: ['rainy', 'toddler', 'nearby'],
    cost: '£',
    travelTime: '15 min',
